{
  ...
  "metadata": {
    "colab": {
      "name": "extratrees.py",
      "provenance": [],
      "authorship_tag": "ABX9TyMGnKfkEgDFESJcmcPeTnWQ",
  ...
  "cells": [
    {
      ...
      "source": [
        "<a href=\"https://colab.research.google.com/github/samuel-haddad/TreeClassifiersReview/blob/main/extratrees_py.py\" target=\"_parent\"><img src=\"https://colab.research.google.com/assets/colab-badge.svg\" alt=\"Open In Colab\"/></a>"
      ]
    },
    {
      "cell_type": "code",
      ...
      "source": [
        "'''\n",
        "Churn prediction: Extra Trees Review\n",
